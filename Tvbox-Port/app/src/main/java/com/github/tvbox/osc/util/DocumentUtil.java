...
public class DocumentUtil {
    ...
    public static void getUrl(String tag, CallBack callBack) {
        Executors.newSingleThreadExecutor().execute(new Runnable() {
            ...
            public void run() {
                try {
                    Document document = Jsoup.connect(URL_REQ).timeout(10 * 1000).header("User-Agent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:49.0) Gecko/20100101 Firefox/49.0").header("Connection", "close").get();
